...
<head>
    ...
    <meta name="description"
        content="Crustella — Café & bakery template (Demo 2): quick order picks, weekly specials carousel, drink configurator, subscriptions & gifts, workshops, FAQ, press band, and improved cart offcanvas." />
    ...
    ============================================================ */
        ...
        .hero {
            ...
            padding: 72px 0 40px;
            border-bottom: 1px solid var(--border);
            background: linear-gradient(135deg, rgba(255, 215, 190, .45), rgba(255, 240, 225, .35)), var(--bg);
            isolation: isolate;
        }
    ...
    <header class="hero" id="overview">
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6">
                    <span class="kicker d-inline-flex align-items-center gap-2 mb-3"><i class="bi bi-fire"></i> Fresh
                        bakes all day</span>
                    <h1 class="display-5 mb-3">Your morning <span
                            style="background:linear-gradient(90deg,var(--accent),#FFB680);-webkit-background-clip:text;background-clip:text;color:transparent">starts
                            here</span></h1>
                    <p class="lead text-muted mb-4">Small-batch pastries, single-origin espresso, and a cozy corner for
                        your inbox.</p>
                    <div class="d-flex flex-wrap gap-2">
                        <a href="#quick" class="btn btn-primary btn-lg"><i class="bi bi-bag-plus"></i> Quick
                            order</a>
                    ...
                    <div class="d-flex gap-4 mt-4 flex-wrap text-muted small">
                        <div><i class="bi bi-clock"></i> Open 7:00–22:00</div>
                        <div><i class="bi bi-wifi"></i> Work-friendly</div>
                        <div><i class="bi bi-bicycle"></i> Free bike racks</div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="row g-3">
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body p-0 position-relative">
                        ...
                        <figure class="m-0">
                            <img id="galleryFull" src="" alt="" class="w-100"
                                style="display:block">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            (function() {
                ...
                document.getElementById('gallery')?.addEventListener('click', (e) => {
                    ...
                    modal.show();
                    // Wait a tick so modal lays out, then show image
