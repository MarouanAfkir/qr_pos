...
<head>
  ...
  <meta name="description"
    content="Crustella — DEMO 2: curated drops, build-a-box, subscriptions, services, improved gallery lightbox, and event coffee-stand booking." />
  <meta name="theme-color" content="#C46E3A" />
  <title>Crustella — Café & Bakery (Demo 2)</title>
  ...
  <style>
    ...
    /* ===== Lightbox enhancements (NEW for Demo 2 gallery) ===== */
...
<body>
  ...
  <nav class="navbar navbar-expand-lg nav-elevated" id="siteNav" aria-label="Main navigation">
    ...
    <div class="container">
      <a class="navbar-brand d-flex align-items-center gap-2" href="#overview">
        ...
        <span class="badge text-bg-light ms-2 fw-semibold" style="border:1px solid var(--border);">Demo 2</span>
      </a>
      ...
      <div class="d-none d-lg-flex align-items-center ms-auto">
        <ul class="navbar-nav align-items-lg-center gap-1">
              ...
              <div class="row g-4 px-2 px-lg-3">
                <div class="col-6 col-xl-3">
                  ...
                  <ul class="list-unstyled small m-0">
                    <li class="mb-2"><a class="mega-link" href="#menu"><i class="bi bi-cup-hot"></i> Espresso
                        & Americano</a></li>
                    <li class="mb-2"><a class="mega-link" href="#menu"><i class="bi bi-cup-hot"></i> Latte &
                        Cappuccino</a></li>
                    <li class="mb-2"><a class="mega-link" href="#menu"><i class="bi bi-cup-straw"></i> Iced
                        & Cold Brew</a></li>
                  </ul>
                </div>
                <div class="col-6 col-xl-3">
                  ...
                  <ul class="list-unstyled small m-0">
                    <li class="mb-2"><a class="mega-link" href="#menu"><i class="bi bi-bag-heart"></i>
                        Croissants & Viennoiseries</a></li>
                    <li class="mb-2"><a class="mega-link" href="#menu"><i class="bi bi-cake"></i> Cakes &
                        Tarts</a></li>
                    <li class="mb-2"><a class="mega-link" href="#menu"><i class="bi bi-basket"></i> Sourdough
                        & Breads</a></li>
                  </ul>
                </div>
                <div class="col-6 col-xl-3">
                  ...
                  <ul class="list-unstyled small m-0">
                    <li class="mb-2"><a class="mega-link" href="#menu"><i class="bi bi-egg-fried"></i> Avo
                        Toast</a></li>
                    <li class="mb-2"><a class="mega-link" href="#menu"><i class="bi bi-egg"></i> Brioche
                        French Toast</a></li>
                    <li class="mb-2"><a class="mega-link" href="#menu"><i class="bi bi-emoji-smile"></i> Kids
                        & Gluten-free</a></li>
                  </ul>
                </div>
                <div class="col-6 col-xl-3">
                  <div class="p-3 rounded-3 border"
                    ...
                    <a href="#drops" class="btn btn-primary btn-sm w-100 mt-3">See today’s drops</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <li class="nav-item"><a class="nav-link" href="#drops">Drops</a></li>
          <li class="nav-item"><a class="nav-link" href="#build">Build-a-Box</a></li>
          <li class="nav-item"><a class="nav-link" href="#gallery">Behind the scenes</a></li>
          ...
          <!-- CTAs -->
          <li class="nav-item ms-1"><a href="#stand" class="btn btn-outline-primary">Book coffee stand</a></li>
    ...
    <div id="navSearchWrap" class="nav-search collapse">
      <div class="container">
        <form class="nav-search-form" role="search" aria-label="Site search"
          ...
          <i class="bi bi-search"></i>
          <input class="form-control nav-search-input" type="search" placeholder="Search menu, pastries, coffee…"
            aria-label="Search">
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNav" aria-labelledby="offcanvasNavLabel"
    ...
    <div class="offcanvas-body">
      ...
      <div class="list-group list-group-flush">
        <a class="list-group-item" href="#drops" data-close>Drops</a>
        <a class="list-group-item" href="#build" data-close>Build-a-Box</a>
        <a class="list-group-item" href="#menu" data-close>Menu</a>
        <a class="list-group-item" href="#gallery" data-close>Behind the scenes</a>
      ...
      <div class="border-top mt-3 pt-3" style="border-color:var(--border)!important;">
        <div class="d-flex gap-2">
          <button id="themeBtnMobile" class="btn btn-light w-100" type="button"><i class="bi bi-moon-stars"></i>
            Theme</button>
  ...
  <header class="hero" id="overview">
    ...
    <div class="container">
      <div class="row align-items-center g-5">
        <div class="col-lg-6">
          <span class="badge-soft d-inline-flex align-items-center gap-2 mb-3"><i class="bi bi-lightning-charge"></i>
            New in Demo 2</span>
          <h1 class="display-5 mb-3">Curated drops, <span
              style="background:linear-gradient(90deg,var(--accent),#FFB680);-webkit-background-clip:text;background-clip:text;color:transparent">build-a-box</span>
            & subscriptions</h1>
          <p class="lead text-muted mb-4">Small-batch pastries, single-origin espresso, and fast pickup — now with new
            ways to order.</p>
          <div class="d-flex flex-wrap gap-2">
            <a href="#drops" class="btn btn-primary btn-lg">See today’s drops</a>
            <a href="#build" class="btn btn-outline-primary btn-lg">Build a pastry box</a>
          </div>
          <div class="d-flex gap-4 mt-4 flex-wrap text-muted small">
            ...
            <div><i class="bi bi-bag-check"></i> Pickup ~10min</div>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="skel" style="border-radius:22px;">
            <img src="{{ asset('assets/img/gallery/bakery.png') }}" alt="Fresh pastry tray"
              class="w-100 h-100" style="object-fit:cover; display:block" loading="eager" fetchpriority="high"
              width="900" height="600" />
          </div>
          <p class="small text-muted mt-2 text-center">All photos are placeholders—replace with your licensed images.</p>
        </div>
      </div>
      ...
      <div class="mt-5 pt-3">
        ...
        <div class="d-flex flex-wrap justify-content-center align-items-center gap-3">
          ...
          <img src="assets/img/clients/tripadvisor-choice.png" alt="Tripadvisor Travelers’ Choice" height="44"
            loading="lazy"
            style="border-radius:10px;border:1px solid var(--border);box-shadow:0 .35rem .9rem rgba(0,0,0,.06);background:#fff;object-fit:cover">
  ...
  <!-- ===== TODAY’S DROPS (Demo 2) ===== -->
  <section id="drops" class="py-5" style="background:var(--surface)">
    <div class="container">
      <div class="d-flex flex-wrap align-items-end justify-content-between gap-3 mb-3">
        <div>
          <h2 class="m-0">Today’s Drops</h2>
          <p class="text-muted m-0">Fresh limited batches — set a reminder.</p>
        </div>
        <div class="d-flex gap-2">
          <button class="btn btn-light btn-sm" id="dropNotify"><i class="bi bi-bell"></i> Notify me</button>
          <a href="#menu" class="btn btn-outline-primary btn-sm"><i class="bi bi-journal-text"></i> Full menu</a>
        </div>
      </div>
      ...
      <div class="row g-4">
        <div class="col-sm-6 col-lg-4">
          <div class="card-soft feature h-100">
            <div class="skel"><img src="{{asset('assets/img/dishes/item_10.png')}}" alt="Cinnamon Roll" class="w-100" loading="lazy"></div>
            <div class="d-flex justify-content-between align-items-start mt-3">
              <h6 class="mb-0">Sticky Cinnamon Roll</h6><strong>$3.8</strong>
            </div>
            <p class="text-muted small mb-2">Fresh trays at 9:00, 12:00, 16:00.</p>
            <div class="d-flex gap-2">
              <button class="btn btn-primary btn-sm"><i class="bi bi-bag-plus"></i> Pre-order</button>
              <span class="badge text-bg-light border small" style="border-color:var(--border)!important;">Seasonal</span>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="card-soft feature h-100">
            <div class="skel"><img src="{{asset('assets/img/dishes/item_9.png')}}" alt="Cold Brew" class="w-100" loading="lazy"></div>
            <div class="d-flex justify-content-between align-items-start mt-3">
              <h6 class="mb-0">Slow-Steep Cold Brew</h6><strong>$4.2</strong>
            </div>
            <p class="text-muted small mb-2">12h steep • ultra smooth.</p>
            <div class="d-flex gap-2">
              <button class="btn btn-primary btn-sm"><i class="bi bi-bag-plus"></i> Add</button>
              <span class="badge text-bg-light border small" style="border-color:var(--border)!important;">Iced</span>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="card-soft feature h-100">
            <div class="skel"><img src="{{asset('assets/img/dishes/item_4.png')}}" alt="Butter Croissant" class="w-100" loading="lazy"></div>
            <div class="d-flex justify-content-between align-items-start mt-3">
              <h6 class="mb-0">Butter Croissant</h6><strong>$3.2</strong>
            </div>
            <p class="text-muted small mb-2">Laminated with AOP butter.</p>
            <div class="d-flex gap-2">
              <button class="btn btn-primary btn-sm"><i class="bi bi-bag-plus"></i> Add</button>
              <span class="badge text-bg-light border small" style="border-color:var(--border)!important;">Best-seller</span>
            </div>
          </div>
        </div>
      </div>

      <div class="alert alert-warning d-flex align-items-center gap-2 mt-4 small" role="status">
        <i class="bi bi-exclamation-triangle"></i>
        Limited quantities — pre-orders held for 15 minutes after your slot.
      </div>
    </div>
  </section>
  ...
  <section id="build" class="py-5">
    <div class="container">
      <div class="text-center">
        <h2 class="mb-1">Build-a-Box</h2>
        <p class="text-muted">Mix 6 or 12 pastries — perfect for sharing.</p>
      </div>

      <div class="card-soft p-3 p-md-4">
        <div class="row g-4 align-items-center">
          <div class="col-lg-7">
            <div class="d-flex flex-wrap gap-2" id="boxItems">
              <!-- chips will be cloned / counted -->
              <span class="box-chip" data-key="croissant"><img src="{{asset('assets/img/dishes/item_4.png')}}" alt="" width="28" height="28" style="border-radius:8px;object-fit:cover"> Croissant
                <span class="badge text-bg-light border" style="border-color:var(--border)!important;" data-count>0</span>
                <button class="btn btn-light btn-sm" data-add type="button" aria-label="Add croissant"><i class="bi bi-plus"></i></button>
                <button class="btn btn-light btn-sm" data-sub type="button" aria-label="Remove croissant"><i class="bi bi-dash"></i></button>
              </span>

              <span class="box-chip" data-key="muffin"><img src="{{asset('assets/img/dishes/item_2.png')}}" alt="" width="28" height="28" style="border-radius:8px;object-fit:cover"> Blueberry Muffin
                <span class="badge text-bg-light border" style="border-color:var(--border)!important;" data-count>0</span>
                <button class="btn btn-light btn-sm" data-add type="button" aria-label="Add muffin"><i class="bi bi-plus"></i></button>
                <button class="btn btn-light btn-sm" data-sub type="button" aria-label="Remove muffin"><i class="bi bi-dash"></i></button>
              </span>

              <span class="box-chip" data-key="cinnamon"><img src="{{asset('assets/img/dishes/item_10.png')}}" alt="" width="28" height="28" style="border-radius:8px;object-fit:cover"> Cinnamon Roll
                <span class="badge text-bg-light border" style="border-color:var(--border)!important;" data-count>0</span>
                <button class="btn btn-light btn-sm" data-add type="button" aria-label="Add cinnamon roll"><i class="bi bi-plus"></i></button>
                <button class="btn btn-light btn-sm" data-sub type="button" aria-label="Remove cinnamon roll"><i class="bi bi-dash"></i></button>
              </span>
            </div>
          </div>
          <div class="col-lg-5">
            <div class="p-3 rounded-3 border" style="border-color:var(--border)!important;background:var(--surface-2)">
              <div class="d-flex align-items-center justify-content-between">
                <div>
                  <div class="fw-bold">Your box</div>
                  <div class="small text-muted">Choose 6 or 12 items</div>
                </div>
                <div class="text-end">
                  <div class="h5 m-0" id="boxTotal">$0.00</div>
                  <div class="small text-muted"><span id="boxCount">0</span> items</div>
                </div>
              </div>
              <div class="progress my-2" style="height:8px;">
                <div class="progress-bar" id="boxProgress" style="width:0%"></div>
              </div>
              <div class="d-flex gap-2">
                <button class="btn btn-primary w-100" id="boxAdd" disabled><i class="bi bi-bag-plus"></i> Add to order</button>
                <button class="btn btn-light" id="boxReset" type="button">Reset</button>
              </div>
              <p class="small text-muted m-0 mt-2">Tip: Fill 12 for the best value.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="text-center mt-3">
        <a href="#menu" class="btn btn-outline-primary"><i class="bi bi-list-ul"></i> Or browse the full menu</a>
      </div>
    </div>
  </section>
  ...
  <section id="menu" class="py-5">
    <div class="container">
      ...
      <ul class="nav nav-pills justify-content-center gap-2 mt-3 menu" id="menuTabs" role="tablist">
        ...
        <li class="nav-item"><button class="nav-link" data-filter="coffee" type="button">Coffee</button></li>
        <li class="nav-item"><button class="nav-link" data-filter="bakery" type="button">Bakery</button></li>
        <li class="nav-item"><button class="nav-link" data-filter="brunch" type="button">Brunch</button></li>
      </ul>
      ...
      <div class="row g-4 mt-1" id="menuGrid">
        ...
        <div class="col-sm-6 col-lg-4" data-category="coffee">
          <div class="card-soft feature h-100">
            <div class="skel"><img src="{{asset('assets/img/dishes/item_1.png')}}" alt="Vanilla Latte" class="w-100" loading="lazy"></div>
            <div class="d-flex justify-content-between align-items-start mt-3">
              <h6 class="mb-0">Vanilla Latte</h6><strong>$4.9</strong>
            </div>
            <p class="text-muted small mb-2">Velvety milk + double shot.</p>
            <div class="d-flex gap-2"><button class="btn btn-outline-primary btn-sm"><i class="bi bi-bag-plus"></i> Add</button><button class="btn btn-light btn-sm">Hot / Iced</button></div>
          </div>
        </div>
        <div class="col-sm-6 col-lg-4" data-category="coffee">
          <div class="card-soft feature h-100">
            <div class="skel"><img src="{{asset('assets/img/dishes/item_6.png')}}" alt="Americano" class="w-100" loading="lazy"></div>
            <div class="d-flex justify-content-between align-items-start mt-3">
              <h6 class="mb-0">Americano</h6><strong>$3.5</strong>
            </div>
            <p class="text-muted small mb-2">Bold espresso, hot water finish.</p>
            <div class="d-flex gap-2"><button class="btn btn-outline-primary btn-sm"><i class="bi bi-bag-plus"></i> Add</button><button class="btn btn-light btn-sm">Classic</button></div>
          </div>
        </div>
        <div class="col-sm-6 col-lg-4" data-category="coffee">
          <div class="card-soft feature h-100">
            ...
            <div class="d-flex gap-2"><button class="btn btn-outline-primary btn-sm"><i class="bi bi-bag-plus"></i> Add</button><button class="btn btn-light btn-sm">Iced</button></div>
          </div>
        </div>
        ...
        <div class="col-sm-6 col-lg-4" data-category="bakery">
          <div class="card-soft feature h-100">
            ...
            <div class="d-flex gap-2"><button class="btn btn-outline-primary btn-sm"><i class="bi bi-bag-plus"></i> Add</button><button class="btn btn-light btn-sm">Best-seller</button></div>
          </div>
        </div>
        <div class="col-sm-6 col-lg-4" data-category="bakery">
          <div class="card-soft feature h-100">
            <div class="skel"><img src="{{asset('assets/img/dishes/item_2.png')}}" alt="Blueberry Muffin" class="w-100" loading="lazy"></div>
            <div class="d-flex justify-content-between align-items-start mt-3">
              <h6 class="mb-0">Blueberry Muffin</h6><strong>$3.1</strong>
            </div>
            <p class="text-muted small mb-2">Moist crumb, bursting berries.</p>
            <div class="d-flex gap-2"><button class="btn btn-outline-primary btn-sm"><i class="bi bi-bag-plus"></i> Add</button><button class="btn btn-light btn-sm">Fresh daily</button></div>
          </div>
        </div>
        <div class="col-sm-6 col-lg-4" data-category="bakery">
          <div class="card-soft feature h-100">
            ...
            <div class="d-flex gap-2"><button class="btn btn-outline-primary btn-sm"><i class="bi bi-bag-plus"></i> Add</button><button class="btn btn-light btn-sm">Seasonal</button></div>
          </div>
        </div>
        ...
        <div class="col-sm-6 col-lg-4" data-category="brunch">
          <div class="card-soft feature h-100">
            <div class="skel"><img src="{{asset('assets/img/dishes/item_5.png')}}" alt="Sourdough Avo Toast" class="w-100" loading="lazy"></div>
            <div class="d-flex justify-content-between align-items-start mt-3">
              <h6 class="mb-0">Sourdough Avo Toast</h6><strong>$8.9</strong>
            </div>
            <p class="text-muted small mb-2">Heirloom tomatoes, feta, herbs.</p>
            <div class="d-flex gap-2"><button class="btn btn-outline-primary btn-sm"><i class="bi bi-bag-plus"></i> Add</button><button class="btn btn-light btn-sm">Vegetarian</button></div>
          </div>
        </div>
        <div class="col-sm-6 col-lg-4" data-category="brunch">
          <div class="card-soft feature h-100">
            <div class="skel"><img src="{{asset('assets/img/dishes/item_7.png')}}" alt="Brioche French Toast" class="w-100" loading="lazy"></div>
            <div class="d-flex justify-content-between align-items-start mt-3">
              <h6 class="mb-0">Brioche French Toast</h6><strong>$9.9</strong>
            </div>
            <p class="text-muted small mb-2">Maple, berries, mascarpone.</p>
            <div class="d-flex gap-2"><button class="btn btn-outline-primary btn-sm"><i class="bi bi-bag-plus"></i> Add</button><button class="btn btn-light btn-sm">Weekend fav</button></div>
          </div>
        </div>
        <div class="col-sm-6 col-lg-4" data-category="brunch">
          <div class="card-soft feature h-100">
            <div class="skel"><img src="{{asset('assets/img/dishes/item_8.png')}}" alt="Herb Omelette" class="w-100" loading="lazy"></div>
            <div class="d-flex justify-content-between align-items-start mt-3">
              <h6 class="mb-0">Herb Omelette</h6><strong>$7.9</strong>
            </div>
            <p class="text-muted small mb-2">Chives, gruyère, side salad.</p>
            <div class="d-flex gap-2"><button class="btn btn-outline-primary btn-sm"><i class="bi bi-bag-plus"></i> Add</button><button class="btn btn-light btn-sm">Gluten-free</button></div>
          </div>
        </div>
      </div>

      <div class="text-center mt-4">
        <a href="#" class="btn btn-outline-primary"><i class="bi bi-journal-text"></i> Download full menu (PDF)</a>
      </div>
    </div>
  </section>
        ...
        <div class="col-lg-8">
          <div class="d-flex align-items-center gap-3">
            <div class="skel" style="width:72px;height:72px;border-radius:14px;flex:0 0 auto;">
              <img src="{{ asset('assets/img/gallery/sticky-cinnamon-roll.png') }}" alt="Cinnamon roll" width="72"
                height="72" style="object-fit:cover" loading="lazy">
            </div>
            <div>
              <h5 class="mb-1">Seasonal favorite: Sticky Cinnamon Roll</h5>
              <p class="text-muted mb-0 small">Baked at 9am, noon & 4pm — limited batch. Pre-order to guarantee yours.</p>
            </div>
          </div>
        </div>
  ...
  <!-- ===== BEHIND THE SCENES (Improved Lightbox) ===== -->
      ...
      <div class="row g-3">
        ...
        <div class="col-6 col-md-4">
          <a href="#" class="d-block gallery-item" data-index="0"
            ...
            <div class="skel"><img src="{{ asset('assets/img/gallery/pastry_detail.png') }}" alt="Pastry detail"
                class="w-100" loading="lazy"></div>
          </a>
        </div>
        <!-- 2 -->
        <div class="col-6 col-md-4">
          <a href="#" class="d-block gallery-item" data-index="1" data-full="{{ asset('assets/img/gallery/cakes.png') }}"
            data-caption="Cakes">
            <div class="skel"><img src="{{ asset('assets/img/gallery/cakes.png') }}" alt="Cakes" class="w-100"
                loading="lazy"></div>
          </a>
        </div>
        <!-- 3 -->
        <div class="col-6 col-md-4">
          <a href="#" class="d-block gallery-item" data-index="2"
            ...
            <div class="skel"><img src="{{ asset('assets/img/gallery/fresh_bread.png') }}" alt="Fresh bread"
                class="w-100" loading="lazy"></div>
          </a>
        </div>
        <!-- 4 -->
        <div class="col-6 col-md-4">
          <a href="#" class="d-block gallery-item" data-index="3"
            ...
            <div class="skel"><img src="{{ asset('assets/img/gallery/latte_art.png') }}" alt="Latte art"
                class="w-100" loading="lazy"></div>
          </a>
        </div>
        <!-- 5 -->
        <div class="col-6 col-md-4">
          <a href="#" class="d-block gallery-item" data-index="4"
            ...
            <div class="skel"><img src="{{ asset('assets/img/gallery/brunch_table.png') }}" alt="Brunch table"
                class="w-100" loading="lazy"></div>
          </a>
        </div>
        <!-- 6 -->
        <div class="col-6 col-md-4">
          <a href="#" class="d-block gallery-item" data-index="5"
            data-full="{{ asset('assets/img/gallery/outdoor_setting.png') }}" data-caption="Outdoor seating">
            <div class="skel"><img src="{{ asset('assets/img/gallery/outdoor_setting.png') }}" alt="Outdoor seating"
                class="w-100" loading="lazy"></div>
          </a>
        </div>
      </div>
  ...
  <section class="py-5 reviews" aria-labelledby="reviewsTitle">
    <div class="container">
      ...
      <div id="tCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="6000" data-bs-pause="hover">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <article class="review-card card-soft" aria-label="Review from Sarah M.">
              <div class="d-flex align-items-center gap-3">
                <img src="{{ asset('assets/img/gallery/review_1.png') }}" alt="Portrait of Sarah" class="avatar" width="56"
                  height="56" loading="lazy" decoding="async">
                <div>
                  <div class="fw-bold d-flex align-items-center gap-2">Sarah M. <span class="source-badge">Google</span>
                  </div>
              ...
              <blockquote class="mb-0">Best croissant in town. Coffee is consistently excellent.</blockquote>
            </article>
          </div>
          ...
          <div class="carousel-item">
            <article class="review-card card-soft" aria-label="Review from Omar K.">
              <div class="d-flex align-items-center gap-3">
                <img src="{{ asset('assets/img/gallery/people_3.png') }}" alt="Portrait of Omar" class="avatar" width="56"
                  height="56" loading="lazy" decoding="async">
                <div>
              ...
              <blockquote class="mb-0">Fast pickup for the office—cinnamon rolls disappear in minutes.</blockquote>
            </article>
          </div>
          ...
          <div class="carousel-item">
            <article class="review-card card-soft" aria-label="Review from Lina A.">
              <div class="d-flex align-items-center gap-3">
                <img src="{{ asset('assets/img/gallery/people_2.png') }}" alt="Portrait of Lina" class="avatar" width="56"
                  height="56" loading="lazy" decoding="async">
                <div>
                  <div class="fw-bold d-flex align-items-center gap-2">Lina A. <span class="source-badge">Yelp</span>
                  </div>
                  <div class="text-warning" aria-label="5 out of 5 stars">
                    <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                      class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
              ...
              <blockquote class="mb-0">Cozy vibe for laptops—great Wi-Fi and plenty of plugs.</blockquote>
            </article>
          </div>
        </div>
        ...
        <div class="carousel-indicators">
          ...
          <button type="button" data-bs-target="#tCarousel" data-bs-slide-to="1" aria-label="Go to Omar’s review">
            <img src="{{ asset('assets/img/gallery/people_3.png') }}" alt="" aria-hidden="true">
          </button>
          <button type="button" data-bs-target="#tCarousel" data-bs-slide-to="2" aria-label="Go to Lina’s review">
      ...
      <div class="d-flex justify-content-center justify-content-lg-end gap-2 mt-3">
        <button class="btn btn-outline-primary btn-sm" type="button" data-bs-target="#tCarousel" data-bs-slide="prev"
          aria-label="Previous">
          <i class="bi bi-chevron-left"></i> Prev
        </button>
        <button class="btn btn-primary btn-sm" type="button" data-bs-target="#tCarousel" data-bs-slide="next"
          aria-label="Next">
      ...
      <div class="row g-4 mt-1">
        <div class="col-md-6 col-lg-4">
          <div class="card-soft service-card h-100">
            <span class="badge rounded-pill mb-2" style="background:rgba(196,110,58,.12);color:var(--accent);border:1px solid var(--border)"><i
                class="bi bi-calendar2-check"></i> Events</span>
            <h6 class="fw-bold">Coffee Stand for Events</h6>
            <p class="text-muted small">Espresso bar + baristas on-site. Optional pastries. Indoors/outdoors.</p>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="card-soft service-card h-100">
            <span class="badge rounded-pill mb-2" style="background:rgba(196,110,58,.12);color:var(--accent);border:1px solid var(--border)"><i
                class="bi bi-briefcase"></i> Office</span>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="card-soft service-card h-100">
            <span class="badge rounded-pill mb-2" style="background:rgba(196,110,58,.12);color:var(--accent);border:1px solid var(--border)"><i
                class="bi bi-shop"></i> Wholesale</span>
    ...
    <div class="container">
      <div class="row g-4 align-items-center">
        <div class="col-lg-6 order-lg-2">
          <div class="skel" style="border-radius:22px;">
            <img src="{{ asset('assets/img/gallery/our_bakers.png') }}" alt="Our bakers" class="w-100 h-100"
  ...
  <section id="stand" class="py-5">
        ...
        <form class="row g-3 needs-validation" id="standForm" novalidate>
          ...
          <div class="col-md-6">
            <div class="input-icon">
              ...
              <input type="text" class="form-control" id="orgName" required placeholder="Your name">
            </div>
          ...
          <div class="col-md-6">
            <div class="input-icon">
              ...
              <input type="email" class="form-control" id="email" required placeholder="you@example.com" autocomplete="email">
            </div>
          ...
          <div class="col-md-6">
            <div class="input-icon">
              ...
              <input type="tel" class="form-control" id="phone" required placeholder="+1 555 000 000" autocomplete="tel">
            </div>
          ...
          <div class="col-md-6">
            ...
            <div class="input-group">
              <button class="btn btn-light" type="button" id="minusAtt"><i class="bi bi-dash"></i></button>
              <input type="number" min="1" class="form-control text-center" id="attendees" required value="50">
              <button class="btn btn-light" type="button" id="plusAtt"><i class="bi bi-plus"></i></button>
            </div>
          ...
          <div class="col-12">
            ...
            <div class="chip-group">
              ...
              <div class="chip">
                ...
                <label for="pkg3"><i class="bi bi-egg-fried"></i> Coffee + Pastries + Light Brunch</label>
              </div>
            </div>
          ...
          <p class="small text-muted m-0">Estimates are indicative; final quote may vary by logistics & menu.</p>
        </form>
      </div>
    </div>
    ...
    <div class="toast-container position-fixed bottom-0 end-0 p-3">
      <div id="standToast" class="toast align-items-center text-bg-success border-0" role="status" aria-live="polite"
        aria-atomic="true">
        <div class="d-flex">
    ...
    <div class="container pb-4">
      <div class="row g-4">
        <div class="col-lg-4">
          <div class="card-soft p-3 h-100" style="background:var(--surface-2)">
            <div class="d-flex align-items-center gap-2 mb-2">
              <img src="{{ asset('assets/img/gallery/logo.png') }}" alt="Crustella" height="36" width="36"
        ...
        <div class="col-6 col-lg-2">
          ...
          <ul class="list-unstyled small m-0">
            <li class="mb-2"><a class="link-body-emphasis" href="#drops">Drops</a></li>
            <li class="mb-2"><a class="link-body-emphasis" href="#build">Build-a-Box</a></li>
            <li class="mb-2"><a class="link-body-emphasis" href="#menu">Menu</a></li>
            <li class="mb-2"><a class="link-body-emphasis" href="#gallery">Behind the scenes</a></li>
          </ul>
        </div>
      ...
      <div class="d-flex flex-column flex-md-row align-items-center justify-content-between pb-4">
        ...
        <div class="d-flex align-items-center gap-3">
          <a href="#overview" class="btn btn-outline-primary btn-sm" id="toTopBtn"><i class="bi bi-arrow-up"></i> Top</a>
        </div>
      </div>
    </div>
  </footer>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      const syncIcon = (el) => {
        if (!el) return;
        el.innerHTML = document.documentElement.getAttribute('data-bs-theme') === 'dark' ? '<i class="bi bi-sun"></i>' : '<i class="bi bi-moon-stars"></i>';
      };
      const toggleTheme = () => {
      ...
      // DROPS: Fake notify
      document.getElementById('dropNotify')?.addEventListener('click', (e) => {
        e.currentTarget.innerHTML = '<i class="bi bi-check2-circle"></i> Notified';
        e.currentTarget.classList.add('btn-success', 'text-white');
        e.currentTarget.classList.remove('btn-light');
        setTimeout(() => {
          e.currentTarget.innerHTML = '<i class="bi bi-bell"></i> Notify me';
      ...
      // BUILD-A-BOX logic
      (function () {
        const itemsWrap = document.getElementById('boxItems');
        if (!itemsWrap) return;
        const state = { croissant: 0, muffin: 0, cinnamon: 0 };
        const price = { croissant: 3.2, muffin: 3.1, cinnamon: 3.8 };
        const max = 12;
        const btnAdd = document.getElementById('boxAdd');
        const btnReset = document.getElementById('boxReset');
        const countEl = document.getElementById('boxCount');
        const totalEl = document.getElementById('boxTotal');
        const prog = document.getElementById('boxProgress');

        function sum() { return Object.values(state).reduce((a, b) => a + b, 0); }
        function total() { return Object.entries(state).reduce((t, [k, v]) => t + v * price[k], 0); }
        ...
        function update() {
          ...
          btnAdd.disabled = !(sum() === 6 || sum() === 12);
          itemsWrap.querySelectorAll('.box-chip').forEach(chip => {
            const key = chip.dataset.key;
            const c = state[key];
            chip.querySelector('[data-count]').textContent = c;
            chip.querySelector('[data-sub]').disabled = (c === 0);
          });
        }
        ...
        itemsWrap.addEventListener('click', (e) => {
          ...
          if (e.target.closest('[data-add]')) {
            if (sum() < max) state[key] = (state[key] || 0) + 1;
          } else if (e.target.closest('[data-sub]')) {
        ...
        btnAdd?.addEventListener('click', () => {
          btnAdd.innerHTML = '<i class="bi bi-check2"></i> Added!';
          btnAdd.classList.add('btn-success', 'text-white');
          setTimeout(() => {
            btnAdd.innerHTML = '<i class="bi bi-bag-plus"></i> Add to order';
            btnAdd.classList.remove('btn-success', 'text-white');
          }, 1600);
        });
      ...
      (function () {
        ...
        function preload(i) {
          const n = new Image(); n.src = data[i]?.src || '';
        }
        ...
        function show(i) {
          ...
          thumbsWrap.querySelectorAll('button')[current]?.scrollIntoView({ inline: 'center', block: 'nearest', behavior: 'smooth' });
          // Preload neighbors
          preload((current + 1) % data.length); preload((current - 1 + data.length) % data.length);
        }
        ...
        // Basic swipe (mobile)
        let startX = 0;
        full.addEventListener('touchstart', (e) => { startX = e.touches[0].clientX; }, { passive: true });
      ...
      (function () {
        ...
        function durationVal() {
          return parseInt((document.querySelector('input[name="duration"]:checked') || { value: '2' }).value, 10);
        }

        function packageVal() {
          return (document.querySelector('input[name="package"]:checked') || { value: 'coffee' }).value;
        }
        ...
        ['change', 'input'].forEach(ev => {
          document.querySelectorAll('input[name="duration"], input[name="package"]').forEach(el => el.addEventListener(ev, calcEstimate));
        });
