...
<head>
    ...
    <meta name="description" content="QResto هو أسرع حل للقائمة الرقمية الذكية لزيادة مبيعات مطعمك وتبسيط التحديثات دون الحاجة إلى طباعة.">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Cairo:wght@400;500;600;700;800&family=Inter:wght@600;700;800&display=swap" rel="stylesheet">
    ...
    <style>
        ...
        h1,h2,h3,h4,h5,h6{
            font-family:'Cairo','Inter',sans-serif;     /* استخدام Cairo للعناوين */
            font-weight:700;
        }
        ...
        .price-toggle .form-check-input{
            cursor:pointer;width:3rem;height:1.5rem;margin-left:.5rem;appearance:none;
        ...
        .price-toggle .form-check-input::before{
            content:'';position:absolute;height:1.2rem;width:1.2rem;top:3px;right:3px;
        ...
        .testimonial-avatar{
            width:60px;height:60px;border-radius:50%;object-fit:cover;margin-left:1rem;
        }
        ...
        <div class="collapse navbar-collapse" id="navMenu">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-white" href="#" id="langDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">AR</a>
    ...
    <div class="container">
        <div class="row align-items-center g-5">
            <div class="col-lg-6 text-center text-lg-end">
                <h1 class="display-5 fw-bold mb-3">قائمتك QR جاهزة خلال <span class="text-decoration-underline">دقيقتين</span></h1>
                <p class="lead mb-4">حدّث أطباقك، صورك وأسعارك في الوقت الحقيقي. لا طباعة ولا تطوير — فقط رمز QR أنيق يليق بعملائك.</p>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <div class="feature-card h-100">
                    ...
                    <p class="small mb-0">استضافة على خوادم موثوقة، نسخ احتياطي يومي، والامتثال الكامل للـ RGPD.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-4">
                <div class="card price-card featured h-100">
                    <div class="card-body text-center p-4 position-relative">
                        ...
                        <p class="display-6 fw-bold my-3"><span class="price" data-monthly="59" data-yearly="50">59</span> درهم<span class="fs-6 fw-normal">/شهر</span></p>
                        <ul class="list-unstyled mb-4 small">
            ...
            <div class="col-md-4">
                <div class="card price-card h-100">
                    <div class="card-body text-center p-4">
                        ...
                        <p class="display-6 fw-bold my-3"><span class="price" data-monthly="129" data-yearly="110">129</span> درهم<span class="fs-6 fw-normal">/شهر</span></p>
                        <ul class="list-unstyled mb-4 small">
            ...
            <div class="col-md-4">
                <div class="testimonial-card h-100 d-flex flex-column">
                    <div class="d-flex align-items-center mb-3">
                        <img src="https://coffeemoca.ma/assets/images/logo/logo.png" alt="Avatar" class="testimonial-avatar">
                        <div>
                            <h6 class="mb-0 fw-semibold">أمين ب.</h6>
                            <small class="text-muted">صاحب مقهى أطلس</small>
                        </div>
                    </div>
                    <p class="mb-0 small">« منذ اعتماد QResto لاحظ زبائننا سهولة الوصول للمعلومات، وقللنا تكاليف الطباعة بنسبة ‎90%‎. »</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="testimonial-card h-100 d-flex flex-column">
                    ...
                    <p class="mb-0 small">« دعم اللغات المتعددة أحدث فرقًا مع السياح. مبيعات الحلويات ارتفعت بفضل الصور الشهية! »</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="testimonial-card h-100 d-flex flex-column">
                    ...
                    <p class="mb-0 small">« بفضل الإحصاءات نعرف الأطباق التي يجب إزالتها والأخرى التي يجب إبرازها. التحديث فوري حتى لفروعنا الثلاثة. »</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="accordion-item">
                ...
                <div id="faqCollapse1" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                    <div class="accordion-body small">
                        ستحصل على جميع ميزات خطة Starter لمدة ‎14‎ يومًا دون الحاجة إلى بطاقة ائتمان. بعد انتهاء الفترة، إذا لم تشترك في خطة مدفوعة، سيتحول حسابك تلقائيًا إلى الخطة المجانية.
                    </div>
                </div>
            </div>
            <div class="accordion-item">
